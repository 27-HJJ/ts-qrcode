...
export class QRUtil {
	...
	每个版本矫正图形的位置
	 */
	PATTERN_POSITION_TABLE: any = PATTERN_POSITION_TABLE
	G15: number = G15
	G18: number = G18
	G15_MASK: number = G15_MASK
	/*
	BCH编码格式信息
	 */
	...
	掩膜算法
	 */
	getMask(maskPattern: any, i: number, j: number): boolean {
		switch (maskPattern) {
	...
	获取RS的纠错多项式
	 */
	getErrorCorrectPolynomial(errorCorrectLength: any): any {
	...
	获取评价
	 */
	getLostPoint(qrCode: any): number {
