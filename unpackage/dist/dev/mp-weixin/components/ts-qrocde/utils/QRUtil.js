...
class QRUtil {
  constructor() {
    this.PATTERN_POSITION_TABLE = PATTERN_POSITION_TABLE;
    this.G15 = G15;
    this.G18 = G18;
    this.G15_MASK = G15_MASK;
  }
  getBCHTypeInfo(data) {
    let d = data << 10;
  ...
  getErrorCorrectPolynomial(errorCorrectLength) {
    let a = new components_tsQrocde_utils_qrPolynomial.QRPolynomial([1], 0);
    for (let i = 0; i < errorCorrectLength; i++) {
      a = a.multiply(new components_tsQrocde_utils_qrPolynomial.QRPolynomial([1, components_tsQrocde_utils_qrPolynomial.QRMath.gexp(i)], 0));
    }
    return a;
  }
  getLostPoint(qrCode) {
    let moduleCount = qrCode.getModuleCount(), lostPoint = 0, darkCount = 0;
